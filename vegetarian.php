    ...
    <div class="container-fluid">
        <div class="color p-3">
            ...
            <div class="row" style="position: relative;">
                <img src="img/vf.jpg" alt="logo" style="width: 100%; height: auto;">

                <div class="welcome-container">
                    <h1 class="welcome-heading">Vegetarian Food</h1>
                </div>
            </div>
            ...
            $query = "SELECT * FROM post WHERE categorys_id = 'vegetarian'";
